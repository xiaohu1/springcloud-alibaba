package com.test.authServer.feign;
 ...
 * @author liujian
 */
@FeignClient(name = "system-module", fallback = UserService.UserServiceFallbackImpl.class)
public interface UserService {
     ...
     * @return UserVo
     */
    @GetMapping(value = "/api/user/getByName/{username}")
    Result<UserInfo> findUserByUsername(@PathVariable("username") String username);

    @Service
    @Slf4j
    class UserServiceFallbackImpl implements UserService {
